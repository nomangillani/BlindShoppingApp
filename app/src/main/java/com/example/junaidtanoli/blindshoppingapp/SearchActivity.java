...
String username,phone,address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingbar=new ProgressDialog(SearchActivity.this);
        loadingbar.setTitle("Please Wait");
        loadingbar.setMessage("Loading Data");
        loadingbar.setCanceledOnTouchOutside(false);
        thedata=new ArrayList<>();
        searchlist=findViewById(R.id.search_list);
adapter=new ShowHomeDataAdapter(SearchActivity.this,thedata);
...
searchlist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        speak("which Item you want to search");
    }
    @Override
        ...
        StringRequest jsonArrayRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    Toast.makeText(SearchActivity.this, ""+thedata.get(0).getDesc()+"with"+thedata.get(0).getPrice(), Toast.LENGTH_SHORT).show();
